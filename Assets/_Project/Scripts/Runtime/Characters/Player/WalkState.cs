...
namespace Vega.Character
{
    public class WalkState : StateBase
    {
        ...
        public WalkState(FsmBase fsm, Animator animator, Rigidbody2D rigidbody2D, Tilemap tilemap, SpriteRenderer spriteRenderer,
            PlayerData playerData) : base(fsm)
        {
            _fsm            = fsm;
            _rb2D           = rigidbody2D;
            _tilemap        = tilemap;
        ...
        private IEnumerator Move(Action onComplete)
        {
            ...
            _playerData.LastPosition = _fsm.transform.position;
            onComplete.Invoke();
        }
