...
namespace Vega.Character
{
    public class IdleState : StateBase
    {
        ...
        public IdleState(FsmBase fsm, Animator animator, InputController inputController, SpriteRenderer spriteRenderer,
            CursorController cursorController) : base(fsm)
        {
            _fsm            = fsm;
            _animator       = animator;
        ...
        private void OnHorizontalChange(bool facingRight)
        {
            ...
            _spriteRenderer.flipX = _animator.GetCurrentAnimatorStateInfo(0).shortNameHash == _idleBack ? !facingRight : facingRight;
        }
